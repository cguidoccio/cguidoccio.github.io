...
function setCookie(param_name, value, exdays) {
    ...
    var c_value = escape(value) + ((exdays == null) ? "" : "; domain=cgsinc.com; path=/; expires=" + exdate.toUTCString());
...
function ppcUrlCookiePart2() {
    ...
    var param_names = new Array(
        'ppcSource;Campaign_Source__c',
        'ppcMedium;Campaign_Medium__c',
        'ppcCampaign;CampaignID__c',
        'ppcKeyword;Campaign_Term__c',
    );
